...
const MenuManager = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editId) {
      ...
      axios
        .put(`https://henza.zaffarsons.com/henza/update-menu/${editId}`, data)
        .then(() => {
          alert("Menu updated");
          resetForm();
          loadMenus();
      ...
      // Add new menu
      axios
        .post("https://henza.zaffarsons.com/henza/add-menus", data)
        .then(() => {
          alert("Menu added");
          resetForm();
          loadMenus();
            ...
            <div className="flex items-center justify-between bg-gray-50 p-3 rounded-md">
              ...
              <div className="flex space-x-2">
                ...
                {node.children.length > 0 && (
                  ...
                  >
                    <ChevronDownIcon 
                      className={`w-4 h-4 transition-transform ${expandedMenus[node.id] ? 'rotate-180' : ''}`} 
                    />
                  </button>
                )}
              </div>
            </div>
            {expandedMenus[node.id] && node.children.length > 0 && (
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
          ...
          <p className="text-blue-100">Create and manage your navigation menus</p>
        </div>
        ...
        <div className="p-6 bg-gray-50 border-t">
          ...
          <p className="mt-3 text-sm text-gray-500">
            This preview shows how your menu will appear on the website. Hover over items to see dropdowns.
          </p>
        </div>
      </div>
    </div>
