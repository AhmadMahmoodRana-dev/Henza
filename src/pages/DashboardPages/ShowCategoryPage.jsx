      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            <Link to={'/dashboard/add-collection'} className="px-4 py-2 bg-blue-600 rounded-md text-white text-sm font-medium hover:bg-blue-700 flex items-center">
              Add Collection
            </Link>
          </div>
        </div>
          ...
          >
            ...
            <td className="px-6 py-4 text-center text-sm font-medium">
              <div className="flex justify-center space-x-2">
                {/* Edit button */}
                <Link
                  to={`/dashboard/add-collection/${item?.VALUE_SET_VALUE}`}
