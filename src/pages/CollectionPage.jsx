        ...
        <div className="flex justify-between items-center mb-6 mt-6">
          ...
          <Listbox value={sortOption} onChange={setSortOption}>
            <div className="relative w-60 text-sm">
              ...
              <Listbox.Options className="absolute z-10 mt-1 max-h-auto w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg border border-gray-300 sm:text-sm">
